...
import { adminAnalyticsQuerySchema, adminAnalyticsSchema, adminAuditQuerySchema, adminAuditSchema, adminBannerInputSchema, adminCampaignInputSchema, adminCampaignWorkspaceSchema, adminCategoryAttributesInputSchema, adminCategoryInputSchema, adminCategoryRequestReviewSchema, adminCouponInputSchema, adminCouponSchema, adminFlashSaleInputSchema, adminKycReviewInputSchema, adminMarketingSchema, adminOrderDetailSchema, adminPlatformSchema, adminToggleInputSchema, adminUserRolesInputSchema, adminUserStatusInputSchema, adminVendorStatusInputSchema, adminVoucherInputSchema, adminWorkspaceSchema, paymentVerificationReviewSchema, platformSettingsInputSchema, platformSettingsSchema, trustCaseActionInputSchema, updateAdminCampaignSchema, updateAdminCouponSchema } from "./admin.js";
