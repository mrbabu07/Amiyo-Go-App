...
export function createOpenApiDocument() {
  return new OpenApiGeneratorV31(registry.definitions).generateDocument({
    ...
    tags: [{ name: "Operations" }, { name: "Returns & Finance" }, { name: "Engagement & Growth" }, { name: "Support" }, { name: "Vendor Workspace" }, { name: "Admin Trust" }, { name: "Identity" }, { name: "Catalog" }, { name: "Shops" }, { name: "Vendor Catalog" }, { name: "Catalog Moderation" }, { name: "Commerce" }, { name: "Orders" }, { name: "Vendor Orders" }, { name: "Delivery" }]
  });
}
