...
export function createAdminRouter() {
  ...
  router.get("/api/v2/admin/workspace/commission-rules/options", async (req, res, next) => { try { res.json(await commissions.options(requireSession(req))); } catch (error) { next(error); } });
