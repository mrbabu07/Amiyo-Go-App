...
import { z } from "zod";
import { answerInputSchema, chatMessageInputSchema, chatThreadInputSchema, createPromotionSchema, questionInputSchema, reviewInputSchema, stockAlertInputSchema, wishlistItemInputSchema } from "@amiyo/contracts";
...
export function createEngagementRouter() {
  ...
  router.use(["/api/v2/wishlist", "/api/v2/alerts", "/api/v2/reviews", "/api/v2/questions", "/api/v2/notifications", "/api/v2/chat", "/api/v2/loyalty", "/api/v2/admin/promotions"], authenticate);
