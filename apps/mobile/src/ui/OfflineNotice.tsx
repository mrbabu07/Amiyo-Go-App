...
const styles = StyleSheet.create({ notice: { backgroundColor: "#7c2d12", paddingHorizontal: 16, paddingVertical: 9, zIndex: 100 }, text: { color: "#fff", fontSize: 12, fontWeight: "600", textAlign: "center" } });
