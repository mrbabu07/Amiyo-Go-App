...
const styles = StyleSheet.create({
  card: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, minWidth: 0, overflow: "hidden", ...Platform.select({ web: { boxShadow: "0 4px 16px rgba(15,23,42,0.06)" }, default: { elevation: 2, shadowColor: "#0f172a", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 8 } }) }, accent: { backgroundColor: colors.primary, height: 3 }, heading: { borderBottomColor: colors.border, borderBottomWidth: 1, gap: 4, minWidth: 0, paddingHorizontal: spacing.md, paddingVertical: 14 }, title: { color: colors.text, flexShrink: 1, fontSize: 17, fontWeight: "900" }, meta: { color: colors.muted, flexShrink: 1, fontSize: 12, lineHeight: 18 }, body: { gap: spacing.sm, minWidth: 0, padding: spacing.md }
});
