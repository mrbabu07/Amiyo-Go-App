...
const styles = StyleSheet.create({ flex: { flex: 1 }, statusCard: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.xl, flexDirection: "row", gap: spacing.md, padding: spacing.xl }, shield: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.lg, height: 58, justifyContent: "center", width: 58 }, statusLabel: { color: "#7dd3fc", fontSize: 9, fontWeight: "900", letterSpacing: 1 }, statusTitle: { color: colors.surface, fontSize: 22, fontWeight: "900", marginTop: 4 }, statusMeta: { color: "#cbd5e1", fontSize: 11, marginTop: 4 }, document: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", gap: spacing.md, paddingVertical: spacing.md }, documentIcon: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, height: 46, justifyContent: "center", width: 46 }, documentReady: { backgroundColor: "#ecfdf5" }, documentTitle: { color: colors.text, fontWeight: "900" }, documentCopy: { color: colors.muted, fontSize: 10, marginTop: 3 }, upload: { borderColor: colors.primary, borderRadius: radius.md, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 9 }, uploadText: { color: colors.primary, fontSize: 10, fontWeight: "900" }, notice: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, padding: spacing.md }, noticeText: { color: colors.text, flex: 1, fontSize: 11, lineHeight: 18 }, primary: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, justifyContent: "center", minHeight: 50 }, primaryText: { color: colors.surface, fontWeight: "900" }, disabled: { opacity: .45 }, success: { color: colors.success, fontWeight: "800", textAlign: "center" }, error: { color: colors.danger } });
