...
const styles = StyleSheet.create({ flex: { flex: 1 }, preview: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.xl, flexDirection: "row", gap: spacing.md, padding: spacing.xl }, logo: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.lg, height: 62, justifyContent: "center", width: 62 }, previewLabel: { color: "#7dd3fc", fontSize: 9, fontWeight: "900", letterSpacing: 1 }, previewTitle: { color: colors.surface, fontSize: 23, fontWeight: "900", marginTop: 4 }, previewMeta: { color: "#cbd5e1", fontSize: 11, marginTop: 4 }, status: { backgroundColor: "rgba(34,197,94,.18)", borderRadius: radius.pill, color: "#bbf7d0", fontSize: 9, fontWeight: "900", overflow: "hidden", paddingHorizontal: 10, paddingVertical: 7 }, field: { gap: 6 }, label: { color: colors.text, fontSize: 12, fontWeight: "800" }, input: { backgroundColor: "#f8fafc", borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, color: colors.text, minHeight: 48, paddingHorizontal: 13 }, multiline: { minHeight: 120, paddingVertical: 12, textAlignVertical: "top" }, count: { color: colors.muted, fontSize: 10, textAlign: "right" }, primary: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, minHeight: 48, justifyContent: "center" }, primaryText: { color: colors.surface, fontWeight: "900" }, disabled: { opacity: .45 }, success: { color: colors.success, fontWeight: "800" }, error: { color: colors.danger }, row: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", gap: spacing.sm, minHeight: 48 }, rowLabel: { color: colors.muted, flex: 1 }, rowValue: { color: colors.text, fontSize: 11, fontWeight: "900" } });
