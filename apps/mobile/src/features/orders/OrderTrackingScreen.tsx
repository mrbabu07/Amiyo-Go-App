...
const styles = StyleSheet.create({
  overview: { alignItems: "center", backgroundColor: colors.primarySoft, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexDirection: "row", gap: spacing.md, padding: spacing.lg }, overviewIcon: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, height: 48, justifyContent: "center", width: 48 }, overviewCopy: { flex: 1 }, overviewTitle: { color: colors.text, fontSize: 20, fontWeight: "700" }, live: { alignItems: "center", backgroundColor: colors.surface, borderRadius: radius.pill, flexDirection: "row", gap: 5, paddingHorizontal: 10, paddingVertical: 6 }, liveDot: { backgroundColor: colors.success, borderRadius: radius.pill, height: 7, width: 7 }, liveText: { color: colors.success, fontSize: 10, fontWeight: "700" }, list: { gap: spacing.md }, card: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, gap: spacing.md, padding: spacing.lg }, cardHeader: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", justifyContent: "space-between", paddingBottom: spacing.md }, shop: { color: colors.text, fontSize: 18, fontWeight: "700" }, muted: { color: colors.muted, lineHeight: 19 }, status: { backgroundColor: colors.primarySoft, borderRadius: radius.pill, color: colors.primary, fontSize: 10, fontWeight: "700", overflow: "hidden", paddingHorizontal: 10, paddingVertical: 6 }, pending: { backgroundColor: "#fff7ed", borderRadius: radius.pill, color: colors.accent, fontSize: 10, fontWeight: "700", overflow: "hidden", paddingHorizontal: 10, paddingVertical: 6 }, trackingRow: { alignItems: "center", backgroundColor: colors.background, borderRadius: radius.md, flexDirection: "row", gap: spacing.md, padding: spacing.md }, trackingCopy: { flex: 1 }, trackingNumber: { color: colors.text, fontWeight: "700" }, timeline: { paddingTop: spacing.sm }, event: { flexDirection: "row", gap: spacing.md, minHeight: 86 }, rail: { alignItems: "center", width: 18 }, dot: { backgroundColor: colors.border, borderRadius: radius.pill, height: 13, width: 13 }, dotActive: { backgroundColor: colors.primary, borderColor: colors.primarySoft, borderWidth: 3, height: 17, width: 17 }, line: { backgroundColor: colors.border, flex: 1, width: 2 }, eventCopy: { flex: 1, paddingBottom: spacing.md }, eventTitle: { color: colors.text, fontWeight: "700" }, eventMeta: { alignItems: "center", flexDirection: "row", gap: 5, marginTop: 5 }, time: { color: colors.muted, fontSize: 11 }, waiting: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, flexDirection: "row", gap: spacing.md, padding: spacing.md }, waitingText: { color: colors.primaryDark, flex: 1, lineHeight: 20 }, back: { alignItems: "center", alignSelf: "flex-start", borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: 11 }, backText: { color: colors.primary, fontWeight: "700" }, empty: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderStyle: "dashed", borderWidth: 1, gap: spacing.lg, padding: 44 }, primary: { backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: spacing.lg, paddingVertical: 13 }, primaryText: { color: colors.surface, fontWeight: "700" }
});
