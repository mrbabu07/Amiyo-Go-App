...
const styles = StyleSheet.create({ button: { alignItems: "center", backgroundColor: "#fff", borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", justifyContent: "center", minHeight: 50, paddingHorizontal: spacing.md }, disabled: { opacity: 0.6 }, mark: { alignItems: "center", borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, height: 28, justifyContent: "center", marginRight: spacing.sm, width: 28 }, markText: { color: "#4285f4", fontSize: 16, fontWeight: "900" }, text: { color: colors.text, fontSize: 14, fontWeight: "900" } });
