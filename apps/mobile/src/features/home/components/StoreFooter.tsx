...
const styles = StyleSheet.create({ footer: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.xl, marginTop: spacing.lg, padding: spacing.xl }, brand: { color: "#fff", fontSize: 24, fontWeight: "900" }, tagline: { color: "#cbd5e1", lineHeight: 20, marginTop: spacing.sm, maxWidth: 520, textAlign: "center" }, links: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm, justifyContent: "center", marginTop: spacing.lg }, link: { borderColor: "#475569", borderRadius: radius.pill, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 8 }, linkText: { color: "#e2e8f0", fontSize: 12, fontWeight: "800" }, copyright: { color: "#94a3b8", fontSize: 10, marginTop: spacing.lg } });
