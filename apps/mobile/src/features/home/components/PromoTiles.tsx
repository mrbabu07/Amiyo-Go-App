...
const styles = StyleSheet.create({
  ...
  kicker: { color: "rgba(255,255,255,0.72)", fontSize: 9, fontWeight: "900", letterSpacing: 0.8, marginTop: spacing.md },
  title: { color: colors.surface, fontSize: 19, fontWeight: "900", lineHeight: 23, marginTop: 4 },
  subtitle: { color: colors.surface, fontSize: 11, fontWeight: "800", marginTop: 7 }
});
