...
const styles = StyleSheet.create({
  ...
  title: { color: colors.surface, fontSize: 34, fontWeight: "900", lineHeight: 39, maxWidth: 530 },
  ...
  secondaryText: { color: colors.surface, fontSize: 14, fontWeight: "900" },
  ...
  statValue: { color: colors.surface, fontSize: 14, fontWeight: "900" },
  statLabel: { color: "rgba(255,255,255,0.76)", fontSize: 9, fontWeight: "800", marginTop: 2 }
});
