...
const styles = StyleSheet.create({
  ...
  actions: { flexDirection: "row", gap: 6 }, iconButton: { alignItems: "center", backgroundColor: "#f8fafc", borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, height: 40, justifyContent: "center", position: "relative", width: 40 }, cartBadge: { alignItems: "center", backgroundColor: colors.accent, borderRadius: radius.pill, height: 17, justifyContent: "center", position: "absolute", right: -2, top: -2, width: 17 }, cartBadgeText: { color: colors.surface, fontSize: 9, fontWeight: "900" },
  ...
  categoryMenu: { alignSelf: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexDirection: "row", minHeight: 420, overflow: "hidden", position: "absolute", top: 126, zIndex: 100, ...menuShadow }, menuSidebar: { backgroundColor: "#f8fafc", borderRightColor: colors.border, borderRightWidth: 1, paddingVertical: 12, width: 270 }, allCategories: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginBottom: 5, marginHorizontal: 12, paddingHorizontal: 12, paddingVertical: 10 }, allCategoriesText: { color: colors.primary, fontSize: 13, fontWeight: "900" }, rootButton: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", minHeight: 43, paddingHorizontal: 20 }, activeRootButton: { backgroundColor: colors.surface }, rootButtonText: { color: colors.text, flex: 1, fontSize: 13, fontWeight: "700" }, activeRootButtonText: { color: colors.primary, fontWeight: "900" },
  menuContent: { flex: 1, padding: spacing.lg }, menuHeader: { alignItems: "flex-start", borderBottomColor: "#f1f5f9", borderBottomWidth: 1, flexDirection: "row", justifyContent: "space-between", paddingBottom: spacing.md }, menuHeadingCopy: { flex: 1 }, menuTitle: { color: colors.text, fontSize: 20, fontWeight: "900" }, menuDescription: { color: colors.muted, fontSize: 12, marginTop: 5 }, shopAllButton: { borderColor: colors.primary, borderRadius: radius.md, borderWidth: 1, paddingHorizontal: 13, paddingVertical: 8 }, shopAllText: { color: colors.primary, fontSize: 11, fontWeight: "900" }, menuGrid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.lg, paddingTop: spacing.lg }, menuColumn: { gap: 8, minWidth: 175, width: "29%" }, menuRoot: { color: colors.text, fontSize: 14, fontWeight: "900" }, menuLeaf: { color: colors.muted, fontSize: 12 }
});
