...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.accent, fontSize: 11, fontWeight: "900", letterSpacing: 0.8 },
  title: { color: colors.text, flexShrink: 1, fontSize: 22, fontWeight: "900", letterSpacing: -0.5, marginTop: 3 },
  ...
  action: { color: colors.text, fontSize: 12, fontWeight: "900" },
  arrow: { color: colors.accent, fontSize: 20, fontWeight: "900" }
});
