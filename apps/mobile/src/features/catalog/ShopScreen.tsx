...
const styles = StyleSheet.create({
  ...
  back: { alignItems: "center", alignSelf: "flex-start", flexDirection: "row" }, link: { color: colors.primary, fontWeight: "900" },
  ...
  logo: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.pill, height: 72, justifyContent: "center", width: 72 }, logoText: { color: "#fff", fontSize: 30, fontWeight: "900" },
  shopCopy: { flex: 1, minWidth: 180 }, title: { color: "#fff", fontSize: 28, fontWeight: "900" }, description: { color: "#cbd5e1", marginTop: 5 }, count: { color: "#7dd3fc", fontSize: 11, fontWeight: "900", marginTop: 8, textTransform: "uppercase" },
  messageButton: { alignItems: "center", backgroundColor: "#fff", borderRadius: radius.md, flexDirection: "row", gap: 7, paddingHorizontal: spacing.lg, paddingVertical: spacing.md }, messageText: { color: colors.navy, fontWeight: "900" },
  mobileFilterButton: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", marginBottom: spacing.md, padding: spacing.md }, mobileFilterCopy: { alignItems: "center", flexDirection: "row", gap: 7 }, mobileFilterText: { color: colors.text, fontWeight: "900" }, mobileFilterMeta: { color: colors.muted, fontSize: 12 }, mobileFilters: { marginBottom: spacing.md },
  catalogLayout: { alignItems: "flex-start", flexDirection: "row", gap: spacing.lg }, sidebar: { width: 250 }, productsArea: { flex: 1, minWidth: 0 },
  productsHeader: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginBottom: spacing.lg }, productsTitle: { color: colors.text, fontSize: 24, fontWeight: "900" }, productsMeta: { color: colors.muted, marginTop: 4 }, clearButton: { backgroundColor: colors.accentSoft, borderRadius: radius.pill, paddingHorizontal: 12, paddingVertical: 7 }, clearText: { color: "#c2410c", fontSize: 12, fontWeight: "800" },
  grid: { flexDirection: "row", flexWrap: "wrap", marginHorizontal: -6, rowGap: 12 }, slot: { paddingHorizontal: 6 },
  emptyState: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, paddingHorizontal: spacing.lg, paddingVertical: 52 }, emptyIcon: { alignItems: "center", backgroundColor: "#f1f5f9", borderRadius: radius.pill, height: 84, justifyContent: "center", marginBottom: spacing.md, width: 84 }, emptyTitle: { color: colors.text, fontSize: 20, fontWeight: "900" }, emptyText: { color: colors.muted, marginTop: 6, textAlign: "center" }, resetButton: { backgroundColor: colors.accent, borderRadius: radius.md, marginTop: spacing.md, paddingHorizontal: spacing.lg, paddingVertical: 11 }, resetButtonText: { color: "#fff", fontWeight: "900" }, error: { color: colors.danger, marginBottom: spacing.md }
});
