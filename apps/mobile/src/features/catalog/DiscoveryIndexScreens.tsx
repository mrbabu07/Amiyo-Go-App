...
const styles = StyleSheet.create({
  safe: { backgroundColor: colors.background, flex: 1 }, page: { minHeight: "100%" }, content: { alignSelf: "center", maxWidth: 1256, padding: spacing.lg, width: "100%" }, departments: { gap: spacing.lg }, department: { backgroundColor: colors.surface, borderRadius: radius.xl, padding: spacing.lg }, departmentHeading: { alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: spacing.md }, icon: { alignItems: "center", borderRadius: radius.lg, height: 58, justifyContent: "center", width: 58 }, headingCopy: { flex: 1, minWidth: 180 }, departmentTitle: { color: colors.text, fontSize: 21, fontWeight: "900" }, shopAll: { color: colors.primary, fontSize: 13, fontWeight: "900" }, children: { flexDirection: "row", flexWrap: "wrap", gap: spacing.md, marginTop: spacing.lg }, childCard: { borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flex: 1, minHeight: 120, minWidth: 220, padding: spacing.md }, childTitle: { color: colors.text, fontSize: 15, fontWeight: "900" }, leafList: { gap: spacing.sm, marginTop: 12 }, leaf: { color: colors.muted, fontSize: 13, lineHeight: 18 }, grid: { flexDirection: "row", flexWrap: "wrap", marginHorizontal: -spacing.sm, rowGap: spacing.md }, cardSlot: { paddingHorizontal: spacing.sm }, shopCard: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, minHeight: 190, padding: spacing.lg }, shopIcon: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.pill, height: 58, justifyContent: "center", width: 58 }, shopInitial: { color: colors.surface, fontSize: 23, fontWeight: "900" }, cardTitle: { color: colors.text, fontSize: 17, fontWeight: "900", marginTop: spacing.md }, cardText: { color: colors.muted, lineHeight: 18, marginTop: 5 }, count: { color: colors.primary, fontSize: 11, fontWeight: "900", marginTop: "auto", paddingTop: spacing.md }, error: { color: colors.danger }
});
