...
export function ProductDetailScreen({ identifier }: { identifier: string }) {
  ...
  async function addToCart() {
    ...
    setCartError(null);
    try {
      const cart = await addCartItem(user, selected.id);
