...
const styles = StyleSheet.create({ steps: { alignItems: "center", alignSelf: "center", flexDirection: "row", marginBottom: spacing.sm, maxWidth: 480, width: "100%" }, step: { alignItems: "center", gap: 5 }, stepIcon: { alignItems: "center", backgroundColor: colors.border, borderRadius: radius.pill, height: 34, justifyContent: "center", width: 34 }, stepIconActive: { backgroundColor: colors.primary }, stepLabel: { color: colors.muted, fontSize: 10, fontWeight: "800" }, stepLabelActive: { color: colors.primary }, stepLine: { backgroundColor: colors.border, flex: 1, height: 2, marginBottom: 17 }, stepLineActive: { backgroundColor: colors.primary, flex: 1, height: 2, marginBottom: 17 }, columns: { alignItems: "flex-start", flexDirection: "row", flexWrap: "wrap", gap: spacing.lg }, main: { flex: 2, gap: spacing.lg, minWidth: 300 }, section: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, gap: spacing.sm, padding: spacing.lg }, sectionHeading: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", gap: 10, marginBottom: spacing.sm, paddingBottom: spacing.md }, sectionIndex: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.pill, height: 28, justifyContent: "center", width: 28 }, sectionIndexText: { color: colors.surface, fontSize: 12, fontWeight: "900" }, sectionTitle: { color: colors.text, fontSize: 19, fontWeight: "900" }, option: { alignItems: "center", borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: spacing.sm, padding: spacing.md }, selected: { backgroundColor: colors.primarySoft, borderColor: colors.primary }, optionCopy: { flex: 1, gap: 3 }, optionTitle: { color: colors.text, fontWeight: "900" }, defaultBadge: { backgroundColor: "#dcfce7", borderRadius: 4, color: colors.success, fontSize: 8, fontWeight: "900", paddingHorizontal: 6, paddingVertical: 4 }, paymentIcon: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, height: 40, justifyContent: "center", width: 40 }, empty: { alignItems: "center", gap: spacing.sm, padding: spacing.lg }, summary: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flex: 1, gap: spacing.md, minWidth: 290, padding: spacing.lg }, summaryTitle: { color: colors.text, fontSize: 20, fontWeight: "900" }, row: { flexDirection: "row", gap: spacing.md, justifyContent: "space-between" }, rowValue: { color: colors.text, fontWeight: "800" }, strong: { color: colors.text, fontSize: 17, fontWeight: "900" }, divider: { borderTopColor: colors.border, borderTopWidth: 1 }, muted: { color: colors.muted, lineHeight: 19 }, secure: { alignItems: "center", backgroundColor: "#ecfdf5", borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, padding: spacing.sm }, secureText: { color: "#166534", flex: 1, fontSize: 11 }, primary: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, justifyContent: "center", minHeight: 48, paddingHorizontal: spacing.lg }, primaryText: { color: colors.surface, fontWeight: "900" }, disabled: { opacity: 0.5 }, link: { color: colors.primary, fontWeight: "900" }, error: { backgroundColor: "#fef2f2", borderRadius: radius.md, color: colors.danger, padding: spacing.md }, centerCard: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderStyle: "dashed", borderWidth: 1, gap: spacing.lg, padding: 44 }, successPanel: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderWidth: 1, gap: spacing.lg, padding: spacing.xl }, successIcon: { alignItems: "center", backgroundColor: colors.success, borderRadius: radius.pill, height: 68, justifyContent: "center", width: 68 }, receipt: { gap: spacing.md, maxWidth: 440, width: "100%" }, notice: { backgroundColor: colors.primarySoft, borderRadius: radius.md, color: colors.primaryDark, maxWidth: 440, padding: spacing.md, width: "100%" } });
