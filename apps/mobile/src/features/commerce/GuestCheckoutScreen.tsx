...
const styles = StyleSheet.create({ columns: { alignItems: "flex-start", flexDirection: "row", flexWrap: "wrap", gap: spacing.lg }, main: { flex: 2, gap: spacing.lg, minWidth: 300 }, section: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, gap: spacing.md, padding: spacing.lg }, sectionTitle: { color: colors.text, fontSize: 19, fontWeight: "900" }, grid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.md }, field: { flex: 1, gap: 6, minWidth: 210 }, full: { flexBasis: "100%" }, label: { color: colors.text, fontSize: 12, fontWeight: "800" }, input: { borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, color: colors.text, minHeight: 46, paddingHorizontal: spacing.md }, option: { alignItems: "center", borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: spacing.sm, minHeight: 48, paddingHorizontal: spacing.md }, selected: { backgroundColor: colors.primarySoft, borderColor: colors.primary }, optionText: { color: colors.text, fontWeight: "800" }, summary: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flex: 1, gap: spacing.md, minWidth: 290, padding: spacing.lg }, summaryTitle: { color: colors.text, fontSize: 20, fontWeight: "900" }, row: { flexDirection: "row", gap: spacing.md, justifyContent: "space-between" }, muted: { color: colors.muted }, value: { color: colors.text, fontWeight: "800" }, strong: { color: colors.text, fontSize: 17, fontWeight: "900" }, divider: { borderTopColor: colors.border, borderTopWidth: 1 }, secure: { alignItems: "center", backgroundColor: "#ecfdf5", borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, padding: spacing.sm }, secureText: { color: "#166534", flex: 1, fontSize: 11 }, primary: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, justifyContent: "center", minHeight: 48, paddingHorizontal: spacing.lg }, primaryText: { color: "#fff", fontWeight: "900" }, disabled: { opacity: 0.55 }, link: { color: colors.primary, fontWeight: "800" }, error: { backgroundColor: "#fef2f2", borderRadius: radius.md, color: colors.danger, marginBottom: spacing.md, padding: spacing.md }, center: { alignItems: "center", backgroundColor: colors.surface, borderRadius: radius.lg, gap: spacing.lg, padding: 48 } });
