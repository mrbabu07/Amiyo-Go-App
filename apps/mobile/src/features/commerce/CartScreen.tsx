...
const styles = StyleSheet.create({ steps: { alignItems: "center", alignSelf: "center", flexDirection: "row", marginBottom: spacing.sm, maxWidth: 480, width: "100%" }, step: { alignItems: "center", gap: 5 }, stepIcon: { alignItems: "center", backgroundColor: "#e2e8f0", borderRadius: radius.pill, height: 34, justifyContent: "center", width: 34 }, stepIconActive: { backgroundColor: colors.accent }, stepLabel: { color: colors.muted, fontSize: 10, fontWeight: "800" }, stepLabelActive: { color: colors.accent }, stepLine: { backgroundColor: colors.border, flex: 1, height: 2, marginBottom: 17 }, columns: { alignItems: "flex-start", flexDirection: "row", flexWrap: "wrap", gap: spacing.lg }, items: { flex: 2, gap: spacing.md, minWidth: 300 }, item: { alignItems: "center", backgroundColor: colors.surface, borderColor: "#edf1f5", borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: spacing.md, padding: spacing.md }, image: { backgroundColor: colors.primarySoft, borderRadius: radius.md, height: 96, width: 96 }, itemCopy: { flex: 1, gap: 5 }, itemName: { color: colors.text, fontSize: 16, fontWeight: "900" }, muted: { color: colors.muted }, price: { color: colors.accent, fontWeight: "900" }, lineTotal: { color: colors.text, fontWeight: "900" }, quantity: { alignItems: "center", flexDirection: "row", gap: 10 }, quantityButton: { alignItems: "center", borderColor: "#dbe3ee", borderRadius: radius.sm, borderWidth: 1, height: 34, justifyContent: "center", width: 34 }, quantityValue: { color: colors.text, fontWeight: "900", minWidth: 20, textAlign: "center" }, summary: { backgroundColor: colors.surface, borderColor: colors.accentSoft, borderRadius: radius.md, borderWidth: 1, flex: 1, gap: spacing.md, minWidth: 280, padding: spacing.lg }, summaryTitle: { color: colors.text, fontSize: 20, fontWeight: "900" }, summaryRow: { flexDirection: "row", justifyContent: "space-between" }, summaryValue: { color: colors.text, fontWeight: "900" }, discount: { color: colors.success, fontWeight: "900" }, divider: { borderTopColor: colors.border, borderTopWidth: 1 }, secureRow: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, padding: spacing.sm }, note: { color: colors.muted, flex: 1, fontSize: 12, lineHeight: 18 }, primary: { alignItems: "center", backgroundColor: colors.accent, borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, justifyContent: "center", minHeight: 50, paddingHorizontal: spacing.lg }, primaryText: { color: colors.surface, fontWeight: "900" }, guestButton: { borderColor: colors.primary, borderRadius: radius.md, borderWidth: 1, justifyContent: "center", minHeight: 48, paddingHorizontal: spacing.lg }, guestText: { color: colors.primary, fontWeight: "900" }, continue: { color: colors.primary, fontSize: 12, fontWeight: "900", textAlign: "center" }, error: { backgroundColor: "#fef2f2", borderRadius: radius.md, color: colors.danger, padding: spacing.md }, centerCard: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderStyle: "dashed", borderWidth: 1, gap: spacing.lg, padding: 44 } });
