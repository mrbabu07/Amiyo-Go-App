...
export function CartScreen() {
  ...
  const checkoutHref = couponQuote?.coupon ? `/checkout?couponCode=${encodeURIComponent(couponQuote.coupon.code)}` : "/checkout";
