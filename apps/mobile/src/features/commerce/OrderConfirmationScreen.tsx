...
const styles = StyleSheet.create({ panel: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderWidth: 1, gap: spacing.lg, padding: spacing.xl }, successIcon: { alignItems: "center", backgroundColor: colors.success, borderRadius: radius.pill, height: 72, justifyContent: "center", width: 72 }, receipt: { backgroundColor: colors.background, borderRadius: radius.md, gap: spacing.md, maxWidth: 620, padding: spacing.lg, width: "100%" }, row: { flexDirection: "row", gap: spacing.lg, justifyContent: "space-between" }, value: { color: colors.text, flexShrink: 1, fontWeight: "700", textAlign: "right", textTransform: "capitalize" }, muted: { color: colors.muted, lineHeight: 19 }, notice: { backgroundColor: colors.primarySoft, borderRadius: radius.md, color: colors.primaryDark, maxWidth: 620, padding: spacing.md, width: "100%" }, steps: { flexDirection: "row", flexWrap: "wrap", gap: spacing.md, justifyContent: "center", width: "100%" }, step: { borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flex: 1, gap: spacing.sm, minWidth: 180, padding: spacing.md }, stepTitle: { color: colors.text, fontWeight: "700" }, actions: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm, justifyContent: "center" }, primary: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, flexDirection: "row", gap: spacing.sm, justifyContent: "center", minHeight: 46, paddingHorizontal: spacing.lg }, primaryText: { color: "#fff", fontWeight: "700" }, secondary: { borderColor: colors.primary, borderRadius: radius.md, borderWidth: 1, justifyContent: "center", minHeight: 46, paddingHorizontal: spacing.lg }, secondaryText: { color: colors.primary, fontWeight: "700" } });
