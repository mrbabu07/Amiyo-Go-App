...
const styles = StyleSheet.create({ container: { gap: spacing.sm }, label: { color: colors.text, fontSize: 13, fontWeight: "800" }, row: { flexDirection: "row", gap: spacing.sm }, inputWrap: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flex: 1, flexDirection: "row", paddingHorizontal: 12 }, input: { color: colors.text, flex: 1, minHeight: 44, paddingHorizontal: spacing.sm }, button: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, justifyContent: "center", minWidth: 78, paddingHorizontal: spacing.md }, buttonText: { color: colors.surface, fontWeight: "900" }, disabled: { opacity: 0.55 }, error: { color: colors.danger, fontSize: 12 }, applied: { alignItems: "flex-start", backgroundColor: "#ecfdf5", borderColor: "#a7f3d0", borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: spacing.sm, padding: spacing.md }, appliedIcon: { paddingTop: 1 }, copy: { flex: 1 }, appliedTitle: { color: "#166534", fontWeight: "900" }, saved: { color: colors.success, fontSize: 12, fontWeight: "800", marginTop: 3 }, note: { color: "#15803d", fontSize: 10, marginTop: 3 }, remove: { color: colors.danger, fontSize: 12, fontWeight: "900" } });
