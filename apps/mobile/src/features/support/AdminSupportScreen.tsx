...
const styles = StyleSheet.create({ error: { color: colors.danger }, summary: { backgroundColor: colors.navy, borderRadius: radius.lg, padding: spacing.lg }, summaryValue: { color: "#fff", fontSize: 32, fontWeight: "900" }, muted: { color: colors.muted, fontSize: 11 }, customer: { color: colors.primary, fontWeight: "800" }, message: { backgroundColor: "#f8fafc", borderRadius: radius.md, gap: 5, padding: spacing.md }, actions: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, chip: { borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 7 }, active: { backgroundColor: colors.primary, borderColor: colors.primary }, chipText: { color: colors.text, fontSize: 10, fontWeight: "800" }, activeText: { color: "#fff" } });
