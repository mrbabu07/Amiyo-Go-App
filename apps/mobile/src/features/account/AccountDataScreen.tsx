...
const styles = StyleSheet.create({ flex: { flex: 1 }, hero: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.lg, flexDirection: "row", gap: spacing.md, padding: spacing.lg }, heroIcon: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, height: 50, justifyContent: "center", width: 50 }, heroTitle: { color: colors.surface, fontSize: 20, fontWeight: "700" }, heroCopy: { color: "#cbd5e1", marginTop: 3 }, grid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, stat: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexGrow: 1, gap: 5, minWidth: 120, padding: spacing.md }, statValue: { color: colors.text, fontSize: 24, fontWeight: "700" }, statLabel: { color: colors.muted, fontSize: 11 }, jsonCard: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, overflow: "hidden" }, jsonHeader: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", justifyContent: "space-between", padding: spacing.md }, jsonTitle: { color: colors.text, fontWeight: "700" }, badge: { backgroundColor: colors.primarySoft, borderRadius: radius.pill, color: colors.primary, fontSize: 9, fontWeight: "700", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 5 }, json: { color: colors.muted, fontFamily: "monospace", fontSize: 11, lineHeight: 17, padding: spacing.md } });
