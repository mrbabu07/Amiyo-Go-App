...
export function AccountState({ action, copy, icon, loading, onPress, title }: { action?: string; copy: string; icon: string; loading?: boolean; onPress?: () => void; title: string }) {
