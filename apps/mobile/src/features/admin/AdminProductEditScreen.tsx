...
const styles = StyleSheet.create({ field: { gap: 6 }, label: { color: colors.text, fontSize: 11, fontWeight: "700" }, input: { backgroundColor: "#f8fafc", borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, color: colors.text, minHeight: 43, paddingHorizontal: 12 }, multiline: { minHeight: 110, paddingTop: 12, textAlignVertical: "top" }, choices: { flexDirection: "row", flexWrap: "wrap", gap: 6 }, choice: { borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 7 }, choiceActive: { backgroundColor: colors.primary, borderColor: colors.primary }, choiceText: { color: colors.muted, fontSize: 10, fontWeight: "600" }, choiceTextActive: { color: colors.surface }, footer: { flexDirection: "row", gap: spacing.sm, justifyContent: "flex-end" }, primary: { backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: spacing.lg, paddingVertical: 13 }, primaryText: { color: colors.surface, fontWeight: "700" }, secondary: { borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, paddingHorizontal: spacing.lg, paddingVertical: 13 }, secondaryText: { color: colors.text, fontWeight: "700" }, disabled: { opacity: .45 }, error: { color: colors.danger, fontWeight: "700" } });
