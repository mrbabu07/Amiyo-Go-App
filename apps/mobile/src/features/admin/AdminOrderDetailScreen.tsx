...
const styles = StyleSheet.create({
  ...
  status: { alignSelf: "flex-start", backgroundColor: "#fff7ed", borderRadius: radius.pill, color: colors.warning, fontSize: 10, fontWeight: "900", overflow: "hidden", paddingHorizontal: 11, paddingVertical: 7 },
  ...
  risk: { backgroundColor: "#7f1d1d", borderRadius: radius.pill, color: "#fecaca", fontSize: 9, fontWeight: "900", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 5 },
  commandTotal: { color: "#fff", fontSize: 34, fontWeight: "900", letterSpacing: -0.7, marginTop: spacing.sm },
  ...
  totalLabel: { color: colors.text, flexShrink: 1, fontWeight: "900" },
  totalValue: { color: colors.success, flexShrink: 1, fontSize: 20, fontWeight: "900" },
  ...
  kicker: { color: colors.primary, fontSize: 9, fontWeight: "900", letterSpacing: 1 },
  ...
  itemTitle: { color: colors.text, flexShrink: 1, fontWeight: "800" },
  itemPrice: { color: colors.text, flexShrink: 1, fontWeight: "900" },
  ...
  complete: { color: colors.success, fontSize: 11, fontWeight: "800", marginTop: spacing.sm },
