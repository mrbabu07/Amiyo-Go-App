...
const styles = StyleSheet.create({ section: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" }, heading: { color: colors.text, fontSize: 21, fontWeight: "900" }, count: { backgroundColor: colors.primarySoft, borderRadius: radius.pill, color: colors.primary, fontSize: 10, fontWeight: "900", overflow: "hidden", paddingHorizontal: 9, paddingVertical: 5 }, body: { color: colors.text, lineHeight: 21 }, actions: { flexDirection: "row", gap: spacing.sm }, chip: { borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 8 }, active: { backgroundColor: colors.primary }, chipText: { color: colors.text, fontSize: 10, fontWeight: "900" }, activeText: { color: "#fff" } });
