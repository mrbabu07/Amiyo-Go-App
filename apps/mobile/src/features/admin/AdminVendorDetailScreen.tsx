...
const styles = StyleSheet.create({
  flex: { flex: 1 }, error: { color: colors.danger }, hero: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.lg, flexDirection: "row", gap: spacing.md, padding: spacing.lg }, legal: { color: colors.text, fontWeight: "900" }, heroText: { color: colors.surface }, heroMeta: { color: "#cbd5e1", fontSize: 11, marginTop: 3 }, meta: { color: colors.muted, fontSize: 11, marginTop: 3 }, badge: { backgroundColor: colors.primary, borderRadius: radius.pill, color: colors.surface, fontSize: 10, fontWeight: "900", overflow: "hidden", paddingHorizontal: 10, paddingVertical: 6 }, metrics: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, metric: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flex: 1, minWidth: 150, padding: spacing.md }, metricValue: { color: colors.text, fontSize: 21, fontWeight: "900" }, actions: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, action: { backgroundColor: colors.primarySoft, borderRadius: radius.sm, paddingHorizontal: 11, paddingVertical: 8 }, actionText: { color: colors.primary, fontSize: 10, fontWeight: "900" }, danger: { backgroundColor: "#fef2f2" }, dangerText: { color: colors.danger }, listRow: { alignItems: "center", borderTopColor: colors.border, borderTopWidth: 1, flexDirection: "row", gap: spacing.sm, paddingVertical: spacing.sm }, link: { color: colors.primary, fontSize: 11, fontWeight: "900" }
});
