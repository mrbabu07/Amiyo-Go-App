...
const styles = StyleSheet.create({
  actions: { alignItems: "flex-end" }, print: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, flexDirection: "row", gap: 7, minHeight: 44, paddingHorizontal: spacing.lg }, printText: { color: "#fff", fontWeight: "900" }, invoice: { alignSelf: "center", backgroundColor: "#fff", borderColor: "#dbe3ea", borderRadius: radius.lg, borderWidth: 1, maxWidth: 850, padding: 32, width: "100%" }, header: { alignItems: "flex-start", flexDirection: "row", flexWrap: "wrap", gap: spacing.lg, justifyContent: "space-between" }, brand: { alignItems: "center", flexDirection: "row", gap: spacing.sm }, mark: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, height: 46, justifyContent: "center", width: 46 }, markText: { color: "#fff", fontSize: 24, fontWeight: "900" }, brandName: { color: "#0f172a", fontSize: 22, fontWeight: "900" }, brandSub: { color: "#64748b", fontSize: 10, fontWeight: "800", letterSpacing: 1 }, company: { color: "#64748b", fontSize: 11, marginTop: spacing.sm }, invoiceMeta: { alignItems: "flex-end" }, invoiceTitle: { color: colors.primary, fontSize: 28, fontWeight: "900", letterSpacing: 2 }, invoiceNumber: { color: "#0f172a", fontWeight: "900" }, meta: { color: "#64748b", fontSize: 10, lineHeight: 16 }, rule: { backgroundColor: colors.primary, height: 3, marginVertical: spacing.lg }, parties: { flexDirection: "row", flexWrap: "wrap", gap: spacing.xl, justifyContent: "space-between" }, party: { flex: 1, minWidth: 240 }, label: { color: colors.primary, fontSize: 9, fontWeight: "900", letterSpacing: 1.2, marginBottom: spacing.sm }, partyName: { color: "#0f172a", fontSize: 16, fontWeight: "900" }, info: { flexDirection: "row", gap: spacing.sm, justifyContent: "space-between", marginBottom: 5 }, infoLabel: { color: "#64748b", fontSize: 10 }, infoValue: { color: "#0f172a", flex: 1, fontSize: 10, fontWeight: "800", textAlign: "right" }, table: { borderColor: "#e2e8f0", borderRadius: radius.md, borderWidth: 1, marginTop: spacing.xl, overflow: "hidden" }, tableHead: { backgroundColor: "#0f172a", flexDirection: "row", padding: spacing.sm }, headText: { color: "#fff", fontSize: 9, fontWeight: "900", width: 90 }, product: { flex: 1, minWidth: 180 }, right: { textAlign: "right" }, row: { alignItems: "center", borderBottomColor: "#e2e8f0", borderBottomWidth: 1, flexDirection: "row", padding: spacing.sm }, productName: { color: "#0f172a", fontSize: 11, fontWeight: "800" }, cell: { color: "#0f172a", fontSize: 10, width: 90 }, summary: { alignSelf: "flex-end", marginTop: spacing.lg, minWidth: 300 }, totalRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 5 }, totalLabel: { color: "#64748b" }, totalValue: { color: "#0f172a", fontWeight: "800" }, grand: { backgroundColor: colors.primarySoft, borderRadius: radius.md, flexDirection: "row", justifyContent: "space-between", marginTop: spacing.sm, padding: spacing.md }, grandLabel: { color: colors.primary, fontWeight: "900" }, grandValue: { color: colors.primary, fontSize: 20, fontWeight: "900" }, footer: { borderTopColor: "#e2e8f0", borderTopWidth: 1, gap: 4, marginTop: 32, paddingTop: spacing.md }, footerTitle: { color: "#0f172a", fontWeight: "900" }, error: { color: colors.danger }
});
