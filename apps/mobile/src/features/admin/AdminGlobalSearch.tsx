...
const styles = StyleSheet.create({
  wrap: { flex: 1, maxWidth: 560, position: "relative", zIndex: 30 }, inputShell: { alignItems: "center", backgroundColor: colors.background, borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, flexDirection: "row", gap: 8, paddingHorizontal: 12 }, focused: { backgroundColor: colors.surface, borderColor: colors.primary }, input: { color: colors.text, flex: 1, fontSize: 13, height: 40, outlineStyle: "none" } as never, results: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, boxShadow: "0 12px 32px rgba(15,23,42,.18)", left: 0, overflow: "hidden", position: "absolute", right: 0, top: 46 }, resultsScroll: { maxHeight: 520 }, row: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", gap: 10, minHeight: 58, paddingHorizontal: 12, paddingVertical: 8 }, icon: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.sm, height: 34, justifyContent: "center", width: 34 }, typeIcon: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.sm, height: 34, justifyContent: "center", width: 34 }, copy: { flex: 1, minWidth: 0 }, titleLine: { alignItems: "center", flexDirection: "row", gap: 8 }, flex: { flex: 1 }, title: { color: colors.text, fontSize: 13, fontWeight: "700" }, subtitle: { color: colors.muted, fontSize: 10, marginTop: 2 }, badge: { backgroundColor: "#f1f5f9", borderRadius: 10, color: "#475569", fontSize: 8, fontWeight: "700", overflow: "hidden", paddingHorizontal: 7, paddingVertical: 3 }, successBadge: { backgroundColor: "#dcfce7", color: "#166534" }, dangerBadge: { backgroundColor: "#fee2e2", color: "#991b1b" }, heading: { backgroundColor: "#f8fafc", color: "#64748b", fontSize: 9, fontWeight: "700", letterSpacing: 1, paddingHorizontal: 12, paddingVertical: 7, textTransform: "uppercase" }, hint: { alignItems: "center", flexDirection: "row", gap: 8, padding: spacing.md }, hintText: { color: colors.muted, flex: 1, fontSize: 12 }, errorText: { color: colors.danger }, detailHeader: { alignItems: "center", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", gap: 8, padding: 10 }, back: { alignItems: "center", height: 32, justifyContent: "center", width: 32 }, detailTitle: { color: colors.text, fontSize: 13, fontWeight: "700" }, detailBody: { padding: spacing.md }, detailName: { color: colors.text, fontSize: 17, fontWeight: "700" }, detailRow: { alignItems: "flex-start", borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: "row", gap: 12, paddingVertical: 8 }, detailLabel: { color: colors.muted, fontSize: 10, fontWeight: "600", width: 70 }, detailValue: { color: colors.text, flex: 1, fontSize: 11, fontWeight: "700", textAlign: "right" }, loader: { margin: spacing.lg }, openButton: { alignItems: "center", backgroundColor: colors.primary, flexDirection: "row", gap: 8, justifyContent: "center", margin: spacing.md, marginTop: 0, padding: 12, borderRadius: radius.md }, openText: { color: "#ffffff", fontSize: 12, fontWeight: "700" }, darkInput: { backgroundColor: "#0f172a", borderColor: "#334155" }, darkResults: { backgroundColor: "#0f172a", borderColor: "#334155" }, darkRow: { borderBottomColor: "#1e293b" }, darkText: { color: "#f8fafc" }
});
