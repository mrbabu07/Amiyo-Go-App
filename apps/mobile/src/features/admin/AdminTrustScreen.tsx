...
const styles = StyleSheet.create({ metrics: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, metric: { backgroundColor: colors.primarySoft, borderRadius: radius.lg, flex: 1, minWidth: 100, padding: spacing.md }, metricValue: { color: colors.primary, fontSize: 26, fontWeight: "700" }, heading: { color: colors.text, fontSize: 21, fontWeight: "700", marginTop: spacing.sm }, label: { color: colors.text, fontSize: 12, fontWeight: "600", marginTop: spacing.sm }, muted: { color: colors.muted, fontSize: 12, lineHeight: 18 }, actions: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, chip: { borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 7 }, active: { backgroundColor: colors.primary, borderColor: colors.primary }, chipText: { color: colors.text, fontSize: 10, fontWeight: "700" }, activeText: { color: "#fff" }, error: { color: colors.danger } });
