...
const styles = StyleSheet.create({
  flex: { flex: 1 }, summary: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.xl, flexDirection: "row", flexWrap: "wrap", gap: spacing.lg, padding: spacing.lg }, ratingBlock: { gap: 4, minWidth: 145 }, score: { color: colors.surface, fontSize: 42, fontWeight: "700" }, stars: { flexDirection: "row", gap: 2 }, summaryMuted: { color: "#cbd5e1", fontSize: 12 }, summaryDivider: { alignSelf: "stretch", backgroundColor: "#334155", width: 1 }, stat: { gap: 4, minWidth: 76 }, statNumber: { color: colors.surface, fontSize: 26, fontWeight: "700" }, list: { gap: spacing.md }, card: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, gap: spacing.md, padding: spacing.lg }, cardHeader: { alignItems: "center", flexDirection: "row", gap: spacing.sm }, productIcon: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, height: 42, justifyContent: "center", width: 42 }, productName: { color: colors.text, fontSize: 16, fontWeight: "700" }, date: { color: colors.muted, fontSize: 11, marginTop: 3 }, verified: { alignItems: "center", backgroundColor: "#ecfdf5", borderRadius: radius.pill, flexDirection: "row", gap: 4, paddingHorizontal: 9, paddingVertical: 6 }, verifiedText: { color: colors.success, fontSize: 10, fontWeight: "700" }, title: { color: colors.text, fontSize: 17, fontWeight: "700" }, body: { color: colors.muted, lineHeight: 22 }, bodyMuted: { color: colors.muted, fontStyle: "italic" }, productLink: { alignItems: "center", alignSelf: "flex-start", borderTopColor: colors.border, borderTopWidth: 1, flexDirection: "row", gap: 6, paddingTop: spacing.md }, linkText: { color: colors.primary, fontWeight: "700" }, empty: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderStyle: "dashed", borderWidth: 1, gap: spacing.md, padding: 44 }, emptyTitle: { color: colors.text, fontSize: 22, fontWeight: "700" }, muted: { color: colors.muted, lineHeight: 20, textAlign: "center" }, primary: { backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: spacing.lg, paddingVertical: 13 }, primaryText: { color: colors.surface, fontWeight: "700" }
});
