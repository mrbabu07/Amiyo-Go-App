...
const styles = StyleSheet.create({ flex: { flex: 1 }, summary: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.lg, flexDirection: "row", gap: spacing.md, padding: spacing.lg }, summaryIcon: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, height: 46, justifyContent: "center", width: 46 }, summaryTitle: { color: colors.surface, fontSize: 19, fontWeight: "900" }, summaryCopy: { color: "#cbd5e1", fontSize: 12, marginTop: 3 }, total: { alignItems: "center", backgroundColor: "#334155", borderRadius: radius.md, minWidth: 58, padding: spacing.sm }, totalNumber: { color: colors.surface, fontSize: 18, fontWeight: "900" }, totalLabel: { color: "#94a3b8", fontSize: 8, fontWeight: "900" }, list: { gap: spacing.sm }, card: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexDirection: "row", gap: spacing.md, padding: spacing.md }, cardUnread: { backgroundColor: "#f8fdff", borderColor: "#bae6fd" }, icon: { alignItems: "center", backgroundColor: colors.background, borderRadius: radius.pill, height: 42, justifyContent: "center", width: 42 }, iconUnread: { backgroundColor: colors.primarySoft }, titleRow: { alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, title: { color: colors.text, fontWeight: "900" }, newBadge: { backgroundColor: colors.primary, borderRadius: radius.pill, paddingHorizontal: 7, paddingVertical: 3 }, newText: { color: colors.surface, fontSize: 8, fontWeight: "900" }, body: { color: colors.muted, lineHeight: 20, marginTop: 4 }, date: { color: colors.muted, fontSize: 10, marginTop: 6 }, empty: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderStyle: "dashed", borderWidth: 1, gap: spacing.md, padding: 44 }, emptyTitle: { color: colors.text, fontSize: 22, fontWeight: "900" }, muted: { color: colors.muted, textAlign: "center" } });
