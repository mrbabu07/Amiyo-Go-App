...
const styles = StyleSheet.create({ flex: { flex: 1 }, hero: { backgroundColor: colors.navy, borderRadius: radius.xl, overflow: "hidden", padding: spacing.lg }, heroTop: { alignItems: "flex-start", flexDirection: "row", justifyContent: "space-between" }, kicker: { color: "#7dd3fc", fontSize: 10, fontWeight: "700", letterSpacing: 1.4 }, balance: { color: colors.surface, fontSize: 46, fontWeight: "700", marginTop: 4 }, points: { color: "#cbd5e1" }, gift: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.lg, height: 58, justifyContent: "center", width: 58 }, heroStats: { alignItems: "center", borderTopColor: "#334155", borderTopWidth: 1, flexDirection: "row", gap: spacing.lg, marginTop: spacing.lg, paddingTop: spacing.md }, statValue: { color: colors.surface, fontSize: 18, fontWeight: "700" }, statLabel: { color: "#94a3b8", fontSize: 11 }, statDivider: { alignSelf: "stretch", backgroundColor: "#334155", width: 1 }, version: { backgroundColor: "#334155", borderRadius: radius.pill, marginLeft: "auto", paddingHorizontal: 10, paddingVertical: 6 }, versionText: { color: "#cbd5e1", fontSize: 9, fontWeight: "700" }, sectionHeader: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" }, sectionTitle: { color: colors.text, fontSize: 20, fontWeight: "700" }, muted: { color: colors.muted, lineHeight: 19 }, list: { gap: spacing.sm }, entry: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexDirection: "row", gap: spacing.md, padding: spacing.md }, entryIcon: { alignItems: "center", backgroundColor: "#ecfdf5", borderRadius: radius.pill, height: 40, justifyContent: "center", width: 40 }, entryIconSpent: { backgroundColor: "#fff7ed" }, entryTitle: { color: colors.text, fontWeight: "700" }, amount: { color: colors.success, fontSize: 18, fontWeight: "700" }, amountSpent: { color: colors.accent }, empty: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.xl, borderStyle: "dashed", borderWidth: 1, gap: spacing.md, padding: 44 }, emptyTitle: { color: colors.text, fontSize: 21, fontWeight: "700" } });
