...
const styles = StyleSheet.create({ crash: { alignItems: "center", flex: 1, justifyContent: "center", padding: 24 }, title: { fontSize: 24, fontWeight: "900" }, body: { marginTop: 10, maxWidth: 420, textAlign: "center" } });
