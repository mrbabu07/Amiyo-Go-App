...
const styles = StyleSheet.create({
  hero: { alignItems: "center", backgroundColor: colors.navy, borderRadius: radius.xl, flexDirection: "row", flexWrap: "wrap", gap: spacing.md, justifyContent: "space-between", padding: spacing.xl }, heroCopy: { flex: 1, minWidth: 250 }, heroLabel: { color: "#7dd3fc", fontSize: 10, fontWeight: "700", letterSpacing: 1 }, heroTitle: { color: colors.surface, fontSize: 24, fontWeight: "700", marginTop: 6 }, heroMeta: { color: "#cbd5e1", marginTop: 5 }, status: { alignItems: "center", backgroundColor: "rgba(245,158,11,.18)", borderRadius: radius.pill, flexDirection: "row", gap: 7, paddingHorizontal: 12, paddingVertical: 8 }, statusApproved: { backgroundColor: "rgba(34,197,94,.18)" }, statusDot: { backgroundColor: "#22c55e", borderRadius: 5, height: 8, width: 8 }, statusText: { color: colors.surface, fontSize: 10, fontWeight: "700" }, metrics: { flexDirection: "row", flexWrap: "wrap", gap: spacing.md }, metric: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flex: 1, flexDirection: "row", gap: spacing.md, minWidth: 210, padding: spacing.md }, metricIcon: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, height: 45, justifyContent: "center", width: 45 }, metricValue: { color: colors.text, fontSize: 20, fontWeight: "700" }, metricLabel: { color: colors.muted, fontSize: 11, marginTop: 2 }, sectionRow: { alignItems: "flex-end", flexDirection: "row", justifyContent: "space-between" }, sectionTitle: { color: colors.text, fontSize: 20, fontWeight: "700" }, sectionMeta: { color: colors.muted, fontSize: 11, marginTop: 3 }, link: { color: colors.primary, fontSize: 12, fontWeight: "700" }, grid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.md }, action: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexDirection: "row", gap: spacing.sm, minWidth: 285, padding: spacing.md, width: "32%" }, actionIcon: { alignItems: "center", backgroundColor: colors.primarySoft, borderRadius: radius.md, height: 44, justifyContent: "center", width: 44 }, actionCopy: { flex: 1 }, actionTitle: { color: colors.text, fontWeight: "700" }, actionMeta: { color: colors.muted, fontSize: 10, lineHeight: 16, marginTop: 3 }, recentHeader: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" }, orderList: { gap: spacing.sm }, order: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, flexDirection: "row", gap: spacing.md, padding: spacing.md }, orderIcon: { alignItems: "center", backgroundColor: colors.accentSoft, borderRadius: radius.md, height: 42, justifyContent: "center", width: 42 }, orderNumber: { color: colors.text, fontWeight: "700" }, orderAmount: { color: colors.text, fontWeight: "700", textAlign: "right" }, orderStatus: { color: colors.primary, fontSize: 9, fontWeight: "700", marginTop: 4, textAlign: "right" }, primary: { alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, padding: spacing.md }, primaryText: { color: colors.surface, fontWeight: "700" }
});
