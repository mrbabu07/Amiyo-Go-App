...
export default function VendorDashboardScreen() {
  ...
  if (!session?.vendorMemberships.length) return <Screen title="Seller registration required" description="Create a seller workspace before opening seller operations."><Pressable accessibilityRole="button" onPress={() => router.replace("/vendor/register")}><Text>Start seller registration →</Text></Pressable></Screen>;
